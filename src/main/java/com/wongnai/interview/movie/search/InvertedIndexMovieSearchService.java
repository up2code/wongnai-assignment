...
import com.wongnai.interview.movie.converter.MovieConverter;
...
public class InvertedIndexMovieSearchService implements MovieSearchService {
	...
	private MovieInvertedIndex indexList;
	...
	public List<Movie> search(String queryText) {
		...
		if(indexList == null) {
			indexList = MovieConverter.invertedIndex(movieRepository.findAll());
		}

		List<Long> ids = indexList.findByQueryText(queryText);
